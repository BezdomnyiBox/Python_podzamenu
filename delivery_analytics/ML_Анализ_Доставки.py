...
def show_charts_guide():
    ...
    guides = [
        ("Распределение отклонений", 
         ...
         "• [ЗЕЛЕНЫЙ] — привоз раньше графика (хорошо)\n"
        ...
        ("Тепловая карта: День × Час",
         ...
         "• [ЗЕЛЕНЫЙ] — привоз вовремя или раньше\n"
         "• [ЖЕЛТЫЙ] — небольшое опоздание\n"
        ...
        ("Динамика отклонений",
         ...
         "• Цвет точки — величина отклонения (зеленый=хорошо, красный=плохо)\n"
...
def create_supplier_charts(parent, df, supplier):
    ...
    ax1.set_title('Распределение отклонений\n(ЗЕЛЕНЫЙ=раньше | СИНИЙ=вовремя | КРАСНЫЙ=позже)', 
    ...
    ax6.set_ylim(0, 105)
    ax6.set_title('Процент вовремя по дням\n(ЗЕЛЕНЫЙ >=80% отлично | ОРАНЖЕВЫЙ 60-80% норма | КРАСНЫЙ <60% плохо)', 
                 fontsize=11, fontweight='bold', pad=10)
